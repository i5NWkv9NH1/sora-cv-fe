...
<template>
  <VHover>
    <template #default="{ isHovering, props }">
      ...
      >
        <div
          class="d-flex flex-column justify-space-between align-center gap-4"
        ...
        >
          ...
          <div
            class="d-flex flex-column align-center text-body-2 gap-4"
          ...
          <div class="d-flex">
            <VBtn
              variant="outlined"
              size="large"
              class="font-weight-bolder text-h6 button"
              rounded="lg"
            >
              开通{{ item.title }}
            </VBtn>
